		...
		<div class="main-section" role="main">
			...
			<?php if ( willow_option( 'enable_social_share' ) ) : ?>
				<div class="social-share">
					<h3 class="separator-title"><span><?php _e( 'Compartilhar', 'willow' ); ?></span></h3>
			...
			<div class="author-box">
				<h3 class="separator-title"><span><?php _e( 'Sobre o autor', 'willow' ); ?></span></h3>
			...
			<?php if ( willow_option( 'enable_related_posts' ) ) : ?>
				...
				if ( have_posts() ) : ?>
					<div class="related-posts">
						<h3 class="separator-title"><span><?php _e( 'Notícias relacionadas', 'willow' ); ?></span></h3>
